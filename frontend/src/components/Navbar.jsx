    ...
    >
      <div className="px-4 md:px-8 py-2.5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
            ...
            >
              {profilePicture ? (
                <img
                  src={profilePicture}
                  alt="Profile"
                  className="h-10 w-10 rounded-full object-cover ring-2 ring-indigo-200 dark:ring-indigo-800"
          ...
          <button
            onClick={logout}
            className="md:hidden p-2 rounded-lg text-rose-600 hover:bg-rose-50 dark:hover:bg-rose-900/20 transition-colors"
          >
